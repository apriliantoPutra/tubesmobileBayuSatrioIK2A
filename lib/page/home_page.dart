...
import 'package:uts/model/rumahsakit.dart';
import 'package:uts/model/user.dart';
import 'package:uts/page/detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final List _bottomNav = [
    ...
    },
    {
      ...
      'icon_off': Icons.chat_bubble_outline,
      'label': 'Favorite',
    },
    {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        unselectedItemColor: Color.fromARGB(255, 7, 115, 7),
       ...
       onTap: (value) {
          ...
          if (_currentNav == 3) {
            Get.to(() => Profile());
          } else if (_currentNav == 2) {
            Get.to(() => FavoritePage());
          }else if (_currentNav == 1) {
            Get.to(() => Homies());
            }
          },
